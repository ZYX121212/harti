...
static const decor_params_t DECOR_NEUTRAL = {.blush = 0.38f, .tears = 0, .stars = 0, .sweat = 0, .sparkle = 0.18f};
...
const expression_def_t EXPRESSION_DEFS[] = {
    ...
    // [1] HAPPY
    {
        ...
        .target = {
            ...
            .decor = {.blush = 0.72f, .tears = 0, .stars = 0.15f, .sweat = 0, .sparkle = 0.35f},
        },
        .timing = {
    ...
    // [8] CONFUSED
    {
        ...
        .target = {
            ...
            .mouth = {
                ...
                .upper_lip_mid = {0, 0.05f}, .lower_lip_mid = {0, 0.02f},
                .openness = 0.1f, .cupid_depth = 0.35f,
            },
